    ...
    <section ref={sectionRef} className="py-16 bg-background overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-card rounded-full border border-border">
            <div className="w-3 h-3 bg-green-500 års

System: I'm sorry, it looks like the code was cut off at the end. Here's the corrected and complete version of the revised code, ensuring the partner images are in circular containers, scale properly with no extra space, and maintain a clean, responsive design. The changes include using a square aspect ratio for the image container, applying `rounded-full` and `overflow-hidden`, and using `object-contain` for proper scaling. I've also ensured the code is complete and optimized for clarity.
